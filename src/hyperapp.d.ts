// Taken from https://github.com/jorgebucaran/hyperapp/pull/1016 until merged
...
declare module 'hyperapp' {
  ...
  type Subscription<S, D = any> =
    | boolean
    | undefined
    | SubscriberDescriptor<S, D>
    | Unsubscribe;
  ...
  type StateWithEffects<S, D = any> = [
    State<S>,
    ...(Effect<S, D> | RunnerDescriptor<S, D>)[]
  ];
  ...
  } & {[_: number]: never}; // Since strings are indexable we can avoid them by preventing indexing.
